 <template>
  ...
  // https://biznews-proxy-server-nodejs-1.vercel.app/v2/top-headlines?sources=techcrunch




  const categoryUrls = {
    Apple: 'https://biznews-proxy-server-nodejs-1.vercel.app/v2/everything?q=apple&from=2024-11-06&to=2024-11-06&sortBy=popularity',
    Tesla: 'https://biznews-proxy-server-nodejs-1.vercel.app/v2/everything?q=tesla&from=2024-10-07&sortBy=publishedAt',
    Business: 'https://biznews-proxy-server-nodejs-1.vercel.app/v2/top-headlines?country=us&category=business',
    TechCrunch: 'https://biznews-proxy-server-nodejs-1.vercel.app/v2/top-headlines?sources=techcrunch',
    WSJ: 'https://biznews-proxy-server-nodejs-1.vercel.app/v2/everything?domains=wsj.com',
  };
  ...
  async function selectHome() {
    ...
    try {
      const response = await axios.get(
        'https://biznews-proxy-server-nodejs-1.vercel.app/v2/top-headlines?country=us'
      );
